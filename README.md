...
## Пример шаблона файла database.ini
Данный файл необходим для подключениия к базе данных и так как содержит персональные данные в проекте отсутствует.
Файл должен находится в корневой папке.
Ниже приведён привем с его организацией
